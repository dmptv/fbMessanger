...
class ChatLogController: UICollectionViewController, UICollectionViewDelegateFlowLayout, NSFetchedResultsControllerDelegate {
    ...
    func handleSend() {
        ...
        let _: Message = FriendsController.createMessageWithText(inputTextField.text!, friend: friend!, minutesAgo: 0, context: context, isSender: true)
    ...
    func simulate() {
        let delegate = UIApplication.shared.delegate as! AppDelegate
        let context = delegate.managedObjectContext
        let _: Message = FriendsController.createMessageWithText("Here's a text message that was sent a few minutes ago...", friend: friend!, minutesAgo: 1, context: context)
        let _: Message = FriendsController.createMessageWithText("Another message that was received a while ago...", friend: friend!, minutesAgo: 1, context: context)
